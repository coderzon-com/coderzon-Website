 ...
 *
 * GENERATED FILE — rewritten wholesale when the source pages are re-ported.
 * Nothing hand-written belongs here; a case study authored by hand lives in
 * its own module beside this one and is combined in `src/data/projects.js`.
 *
