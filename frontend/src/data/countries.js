/**
 * Every country, for the country selector on the contact and quote forms.
 *
 * Generated from the runtime's own CLDR data rather than typed by hand, so no
 * country is missed or misspelled. Holds all 249 officially assigned
 * ISO 3166-1 alpha-2 codes, plus Kosovo (XK) — user-assigned rather than
 * official, but a populated territory people need to be able to select.
 *
 * Withdrawn codes (AN, SU, YU, ZR, ...), exceptionally reserved codes
 * (EU, UN, AC, ...) and CLDR aggregates (ZZ, QO) are deliberately excluded.
 *
