const data = [
  {
    ...
    p1: "Today, few businesses can complain about the shortage of data. But just having it is not enough to drive decisions. There’s a sustainable way to empower your business with critical insights – make data truly awesome with Microsoft Business Intelligence Consulting. Our BI experts address the challenges of the Power BI deployment, customization, and post-implementation support to transform raw data into rich visuals.",

    h3: "From Data to Actions: Unleashing Power BI’s Full Potential",
    p2: "Whether you’re evaluating business needs, planning to get started with Power BI, or looking to revamp an existing solution, our consulting services guide you every step of the way. We enable seamless integration, design optimal architectures, and deliver tailored visualizations to make data analysis actionable and business-driven.",

    h4_1: "Why Power BI Consulting Matters",
    p3: "Power BI transforms how you interact with data — moving beyond basic dashboards to a comprehensive BI ecosystem. From predictive analytics and real-time insights to cross-platform integrations, we turn your BI investment into a strategic asset. Whether it's connecting ERP, CRM, or HRMS systems, we help unify your enterprise data.",
    ...
    h4_2: "Secure, Scalable, and Strategic Analytics",
    p4: "Security and scalability are at the heart of our solutions. With row-level security, data encryption, and permission controls, we protect your data while enhancing usability. From mobile accessibility to embedded analytics, we ensure you can access insights wherever and whenever you need them.",

    p5: "To elevate your analytics capabilities further, we integrate Power BI with Azure Synapse, Data Factory, Databricks, and Azure ML. This allows for streaming data, advanced machine learning, and robust data pipelines that unlock end-to-end BI value. Our solutions support agile scaling, predictive insights, and operational efficiency.",

    p6: "Our Power BI Consulting Workflow",
    ...
    mobileAndEmbeddedBenefits: {
      mobile: "Power BI mobile setup for iOS and Android enables real-time, on-the-go data access and collaboration with 360-degree visibility from any device.",
      embedded: "Power BI Embedded delivers secure, interactive dashboards within your existing business applications—eliminating per-user licensing while simplifying analytics delivery.",
    },
    ...
    realTimeAnalytics: {
      description: "With Azure Stream Analytics, we enable true real-time dashboards that visualize data from IoT sensors and streaming sources without page refreshes or scheduled jobs.",
      components: [
  ...
  },
  {
    ...
    p1: "Enjoy the freedom and flexibility of open-source BI software. We help get your startup or midsize business off the ground with no significant investment or vendor lock-in. Start small and build up your BI fast and at affordable costs.",

    h3: "Bringing the Best of Two Worlds: Custom BI Development Based on Open-Source Technology",
    p2: "Own your end-to-end business intelligence journey with our bespoke BI solutions built for the unique challenges of your company at a reasonable cost. Our team of BI engineers will help you organize data, generate visualizations, and promote data literacy within a transparent code base.",

    h4_1: "Benefits of Open-Source BI at CoderZon",
    p4: "Our open-source BI approach offers flexibility, cost-effectiveness, and scalability to meet diverse data needs across your organization.",
    list: [
    ...
    h4_2: "Choose a Trusted Partner for BI Success",
    p5: "We offer software-agnostic BI development tailored to your enterprise. From API integrations and custom data sources to role-based dashboards and airtight security, we provide a complete BI transformation with full control and transparency.",

    p6: "Our Custom BI Development Process",
    ...
    mobileAndEmbeddedBenefits: {
      mobile: "Cross-platform mobile access to analytics dashboards ensures real-time decision-making on the go with full BI visibility.",
      embedded: "Embed open-source dashboards into existing business systems to provide internal stakeholders with real-time, actionable insights without extra licensing costs.",
    },
    ...
    realTimeAnalytics: {
      description: "Our open-source stack supports streaming analytics with zero-latency dashboards that reflect real-time data from sensors, APIs, and user interactions.",
      components: [
...

{
  ...
  "mobileAndEmbeddedBenefits": {
    "mobile": "Mobile-accessible cloud dashboards allow you to monitor AWS resources and metrics on-the-go via the AWS Console Mobile App or custom cloud-native interfaces.",
    "embedded": "Embed secure AWS cloud monitoring dashboards directly into enterprise applications for unified operational visibility and reduced overhead."
  },
...
,
{
  ...
  "p1": "On a mission to grow your ecommerce business? Our Shopify development company delivers revenue-generating, growth-focused shopping experiences — from first click to checkout — to elevate your entire customer journey.",

  "h3": "Let CoderZon grow your ecommerce business with Shopify",
  "p2": "Our Shopify experts build high-performance, brand-aligned online stores, empowering merchants to scale with end-to-end ecommerce solutions. We streamline store setup, customization, integrations, and optimizations to enhance user experience, boost conversions, and drive sustained growth.",

  "h4_1": "Shopify Development Services",
  "p4": "We provide comprehensive Shopify ecommerce development services including store setup, theme customization, custom app development, third-party integrations, migration, marketing automation, analytics, and ongoing support.",
  ...
  "h4_2": "How CoderZon delivers Shopify success",
  "p5": "From design to data and performance to personalization, we ensure every element of your Shopify ecosystem works in harmony to meet your goals.",
  "p6": "Explore our Shopify ecommerce capabilities tailored to your business",
  ...
  "mobileAndEmbeddedBenefits": {
    "mobile": "Mobile-optimized and responsive Shopify themes and storefronts for seamless user experience on all devices.",
    "embedded": "Custom APIs and integrations embed Shopify features into your business systems and workflows."
  },
  ...
  "realTimeAnalytics": {
    "description": "Enable real-time sales tracking, order status, and customer engagement insights by integrating Shopify with live reporting and alerting systems.",
    "components": [
...
},
{
  ...
  "p1": "Looking to build a robust and scalable online presence? Our WordPress outsourcing services help your website grow in sync with your evolving business goals.",
  "h3": "Let CoderZon elevate your website with WordPress",
  "p2": "CoderZon WordPress experts deliver high-performance websites with scalable architectures, fast delivery, and optimized costs. From online marketplaces to corporate websites and educational platforms — we empower you with tailored WordPress solutions.",
  "h4_1": "WordPress Development Services",
  "p4": "We offer full-cycle WordPress development services including custom theme and plugin development, third-party integrations, performance optimization, website migration, and ongoing support.",
  "list": [
  ...
  "h4_2": "How CoderZon delivers WordPress excellence",
  "p5": "From migration to customization and maintenance, we ensure your WordPress solution is tailored to your exact requirements and optimized for performance.",
  "p6": "Explore our WordPress capabilities crafted to support your long-term digital growth",
  "Workflow": [
    {
  ...
  "mobileAndEmbeddedBenefits": {
    "mobile": "Mobile-optimized and responsive WordPress themes for seamless experience across all devices.",
    "embedded": "Custom APIs and plugin-based integrations to embed WordPress capabilities into your existing business systems."
  },
  "predictiveAndAdvancedAnalytics": {
    "capabilities": [
  ...
  "realTimeAnalytics": {
    "description": "Enable real-time tracking and insights with integrated analytics tools and custom dashboards tailored for WordPress.",
    "components": [
